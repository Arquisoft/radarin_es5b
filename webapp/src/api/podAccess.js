...
async function checkTodayFileAndCreate(url,nombreFichero){
	...
	var ficheros=await getFile(url+"public/radarin/ubicaciones/ubicaciones.txt")
	...
	await addToFile(url+"public/radarin/ubicaciones/ubicaciones.txt"," "+nombreFichero);
	...
	await updateFile(url+"public/radarin/ubicaciones/"+nombreFichero, json); //Creamos el fichero con las ubicaciones de hoy
}
